  ...
  return (
    <section className="py-14 lg:py-20">
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-5">
          {[
            ...
            <div key={p.t} className="rounded-2xl border bg-surface p-6">
              ...
              <h3 className="font-display font-semibold text-foreground text-lg">{p.t}</h3>
        ...
        {/* Process */}
        <div className="mt-16">
          <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-8">Our Testing Process</h2>
          <ol className="space-y-4">
            {steps.map((s, i) => (
              <li key={s.t} className="rounded-2xl border bg-surface p-5 flex gap-5">
                ...
                <div>
                  <h3 className="font-display font-semibold text-foreground">{s.t}</h3>
        ...
        {/* Legal */}
        <div className="mt-16 rounded-2xl p-6 border text-sm leading-relaxed" style={{ background: "#FFF8E6", borderColor: "rgba(245,181,68,0.3)", color: "#92400E" }}>
        ...
        <div className="mt-10 rounded-2xl border bg-surface p-6">
          <h3 className="font-display font-semibold text-foreground text-lg">Contact</h3>
